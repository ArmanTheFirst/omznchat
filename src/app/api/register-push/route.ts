...
export async function POST(req: Request) {
  try {
    ...
    const privateMetadata = user.privateMetadata as { subscriptions?: Array<PushSubscription & { sessionId: string }> };
    const userSubscriptions = privateMetadata.subscriptions || [];
