...
import LoadingButton from "@/components/chat/LoadingButton";
...
export default function UsersMenu({
  ...
  return (
    <div className="str-chat absolute z-10 h-full w-full overflow-y-auto border-e border-e-[#DBDDE1] bg-white dark:border-e-gray-800 dark:bg-[#020817]">
      <div className="flex flex-col p-3">
        ...
        <input
          type="search"
          placeholder="Search"
          className="rounded-full border border-gray-300 px-4 py-2 dark:border-gray-800 dark:bg-[#020817] dark:text-white"
          value={searchInput}
...
function UserResult({
  ...
  return (
    <button
      className="mb-3 flex w-full items-center gap-2 p-2 hover:bg-[#e9eaed] dark:hover:bg-[#020817]"
    ...
    >
      ...
      />
      <span>
        <Avatar image={user.image} name={user.name || user.id} className="h-10 w-10" />
      </span>
...
function StartGroupChatHeader({
  ...
  return (
    <div className="sticky top-0 z-10 flex flex-col gap-3 bg-white p-3 shadow-sm dark:bg-[#020817]">
      <input
